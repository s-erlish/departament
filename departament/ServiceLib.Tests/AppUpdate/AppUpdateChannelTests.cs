...
/// отвергаться: иначе «Обновить» снова поставит чужое приложение (как было с выпусками апстрима).
/// </summary>
public class AppUpdateChannelTests
{
    ...
    [Theory]
    [InlineData("https://api.github.com/repos/someone/other-vpn/releases/latest")]
    ...
    [InlineData("other-windows-64.zip", false)]
    [InlineData("other-windows-64-desktop.zip", false)]
    ...
    [Theory]
    [InlineData("v1.2.0", "other-windows-64.zip")]
    [InlineData("v1.2.0", "sing-box-1.14.1-windows-amd64.zip")]
    [InlineData("latest", "departament-windows-x64.zip")]
    [InlineData("v1.2.0/../../../someone/other-vpn/releases/download/7.0.0", "departament-windows-x64.zip")]
    ...
    [InlineData("https://github.com/someone/other-vpn/releases/download/7.23.4/other-windows-64.zip")]
    // Другой репозиторий того же владельца: выпуски берутся только из s-erlish/departament.
    [InlineData("https://github.com/s-erlish/other/releases/download/v1.2.0/departament-windows-x64.zip")]
