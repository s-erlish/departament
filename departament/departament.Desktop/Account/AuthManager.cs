...
/// <summary>UI-facing state of a login attempt. Port of the Android app's auth/AuthManager.LoginState.</summary>
...
/// <see cref="AccountSession"/>/<see cref="AuthTokenStore"/>. Port of the Android app's auth/AuthManager.kt.
/// </summary>
