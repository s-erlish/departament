...
/// <summary>
/// Backs the «Купить подписку» screen. Port of the Android app's ui/BuyTariffActivity.kt (+ PaymentMethodSheet.kt):
...
public class BuyViewModel : MyReactiveObject
{
    ...
    internal static string FormatMoney(double amount, string currency) => departament.Desktop.Common.Money.WithCurrency(amount, currency);
