...
/// from the Android app's ui/adapter/PaymentsAdapter.kt), so the view binds text verbatim and never formats.
...
/// <summary>
/// Backs the «История платежей» sub-screen. Port of the Android app's PaymentHistoryActivity.kt +
...
public class PaymentHistoryViewModel : MyReactiveObject
{
    ...
    private static string FormatMoney(double amount, string currency) => departament.Desktop.Common.Money.WithCurrency(amount, currency);
