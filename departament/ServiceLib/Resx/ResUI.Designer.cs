...
namespace ServiceLib.Resx {
    ...
    public class ResUI {
        ...
        /// <summary>
        ///   查找类似 Export departament Internal Share Link to Clipboard 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Only applies to the departament GUI&apos;s downloads and network requests. Does not affect the core&apos;s certificate validation. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 departament settings 的本地化字符串。
        /// </summary>
