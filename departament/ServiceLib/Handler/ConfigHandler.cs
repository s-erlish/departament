...
public static class ConfigHandler
{
    ...
    public static async Task<int> AddSubItem(Config config, string url)
    {
        ...
        SubItem subItem = new()
        {
            Id = string.Empty,
            Url = url,
            // Stamp the recognised mobile-client UA (Global.SubscriptionUserAgent) on manually-added subs (paste / clipboard / QR)
    ...
    //  Умолчания апстрима, которые InitBuiltinSimpleDNS писал в конфиг сам, без человека: 7.21+
